        ...
        <div class="panel panel-default">
            ...
            <div class="row w3-res-tb">
                <div class="col-sm-5 m-b-xs">
                    ...
                    <a href="{{ route('addProductBrand')}}" class="btn btn-primary">Thêm mới thương hiệu</a>
                </div>
                <div class="col-sm-3">
                ...
                <table class="table table-striped b-t b-light">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $brand->product_brand_desc}}</td>
                            ...
                            <td style="display:flex">
                                <a style="margin-right: 8px" href="{{ route('editProductBrand', $brand->id) }}" class="btn btn-primary" ui-toggle-class="">Sửa</a>
                                {{-- <a href="" class="btn btn-danger" ui-toggle-class="">Xóa</a> --}}

                                <form action="{{ route('deleteProductBrand', $brand->id) }}" method="POST" role="form">
                                    @csrf
                                    @method('delete')
